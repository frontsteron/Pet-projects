...
1. ### **Восприимчивость**/**понимание** - всё должно восприниматься/пониматься свободно,
2. ### **Ориентиентация** - должна быть легкая ориентаци на сатйте/в приложении,
3. ### **Взаимодействовать**/**вносить свой вклад** - например: заполнять формы обратной связи(*при необходимости*).
...
3. ### **Временное нарушение здоровья** - при временной нетрудоспособности,
4. ### **На ярком солнце/в шумном месте** - при непредвиденных ситуациях,
