...
<body> <!-- тело страницы -->
  ...
  <h1>..<h6></h1>..</h6> <!-- заголовков секции(кратко и ясно, значение block), h1 на странице только 1, а все остальные хоть сколько, они вложенные -->
  ...
  <em></em> or <i></i> <!-- курсив, em - значимый -->	
	...
	<a href="link" target="_blank"></a> <!-- ссылка на новую вкладку(значение inline) -->
