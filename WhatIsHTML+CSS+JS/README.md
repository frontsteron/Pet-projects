...
* ### **let** - область видимости: блок(***let** область видимости: функция*).
* ### **const** - область видимости: блок(***let** область видимости: функция*).
...
### Это мы явно приводили типы, а неявно в **JS** всего избегать.
---
