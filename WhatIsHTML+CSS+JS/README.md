...
### Подключаем скриптовый файл(***JS***) в теге **head**. Делаем отдельный файл чтобы не нагружать **html** документ(*чтобы было легче поддерживать код*) и чтобы быстрее загружались страницы.
