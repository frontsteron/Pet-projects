...
<details> 
  <summary>Встроенные методы(функции) к этому типу данных</summary> 
...
### Преобразование в строку - **String**. В JavaScript можно преобразовать разные типы данных в строки с помощью метода `toString()` или оператора конкатенации `+`. Например:
```JavaScript
let num = 42;
...
### Это мы явно приводили типы, а неявного приведения типов в **JS** нужно избегать.
---
