...
<body> <!-- тело страницы -->
  ...
  <legend></legend> <!-- название полей -->
   <input type=search placeholder="Указывает сожидаемое значение для ввода"> <!-- однострочный ввод текста или номера; выводит текст внутри поля формы, который исчезает при получении фокуса, а Password делает текст скрытым -->
   <textarea></textarea> <!-- многострочный ввод текста -->
