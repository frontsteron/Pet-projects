...
### А по умолчанию нужно использовать **const**, где при желании используем ВЕРХНИЙ_РЕГИСТР и snake_case.
...
age = 40
```
### **JavaScript** предоставляет широкий спектр встроенных функций, которые можно использовать для различных целей. Вот некоторые часто используемые функции в JavaScript:
