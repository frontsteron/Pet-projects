...
<!-- либо если не подключать фафйл стилей, то можно таким образом писать в любом теге с атрибутом style прямо в html <tag style="property: value"> </tag>  -->
```
...
+ ### Мультипарадигменный - писать можно, используя объектно-ориентированную парадигму, в функциональном и можно в императивном стиле.
