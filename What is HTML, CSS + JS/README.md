...
<body> <!-- тело страницы -->
		...
		<em></em> or <i></i> <!-- курсив, em - значимый -->	
			<p></p> <!-- абзац/текст где нет других тегов, зачасту. в div, общий елемент, не имеющий абсолютного/конкретного значения и если 2 тега, то начинается с новой строки -->
