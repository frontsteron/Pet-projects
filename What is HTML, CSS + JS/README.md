...
<body> <!-- тело страницы -->
		...
		<main></main> <!-- определят контент специфичный для конкретной страницы(1) -->
		...
		<div></div>	<!-- группы элементов/панель навигации, описывает блочный документ, и расплогается на всю ширину body --> 
		<span></span> <!-- строчный документ и распологается на ширину контента -->
