...
### По умолчанию мы используем **const**, где при желании используем ВЕРХНИЙ_РЕГИСТР и snake_case.

### А при необходимости обновить значение пересенной **let**, обновляем её через простое равно(*оператор assign*(*=*)).
